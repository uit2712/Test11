...
class CheckoutForm extends Component {
    ...
    if (this.props.cart.fetched === false) {
      this.props.dispatch(dispatch => {
        ...
        api
          ...
          .then(cart => {
            this.setState({ products: cart.data });
  ...
  completeOrder = () => {
    const products = this.state.products;
    window.completeOrder(products, eventCategory);
  }
            ...
            <form
              ...
              <fieldset className="details">
                ...
                <div className="form-content">
                  ...
                  <button type="button" className="continue" onClick={() => this.checkOutStep(1)}>
                    Continue
                  </button>
                </div>
              </fieldset>
              <fieldset className="billing collapsed">
                ...
                <div className="form-content">
                  ...
                  <button type="button" className="continue"  onClick={() => this.checkOutStep(2)}>
                    Continue
                  </button>
                </div>
              </fieldset>
              <fieldset className="shipping collapsed">
                ...
                <div className="form-content">
                  ...
                  <button type="button" className="continue" onClick={() => this.checkOutStep(3)}>
                    Continue
                  </button>
                </div>
              </fieldset>
              <fieldset className="payment collapsed">
                ...
                <div className="form-content">
                  ...
                  <button type="submit" className="pay" aria-live="polite" onClick={() => this.completeOrder()}>
